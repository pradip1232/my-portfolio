...
const projectsData = {
  "projects": [
    ...
    },
    {
      ...
      "description": "Comprehensive pesticide management platform with user and admin dashboards. Features product catalog, order management, inventory tracking, and safety guidelines. Built with React.js, PHP, MySQL, and deployed via cPanel with CI/CD pipeline.",
    ...
    },
    {
      ...
      "description": "Admin panel for product management with uploads, pricing, and inventory. Built with ReactJS, Tailwind CSS, Material-UI, PHP, and MySQL. Deployed via cPanel or GCP for scalability.",
    ...
    },
    {
      ...
      "description": "A stunning jewelry e-commerce platform built with Next.js, MongoDB, Stripe, and Tailwind CSS. Features product search, collection browse, secured checkout and beautiful UI.",
    ...
    },
    {
      ...
      "description": "An online education platform for interactive courses, quizzes, and progress tracking. Built with React, Node.js, Express, and PostgreSQL.",
      "image": "https://images.unsplash.com/photo-1503676382389-4809596d5290?w=800&h=600&fit=crop",
    ...
    },
    {
      ...
      "description": "A B2B marketplace connecting manufacturers and retailers, with secure messaging, deal management, and analytics. Built using Next.js, NestJS, AWS, and GraphQL.",
...
// Get all projects from embedded data
