/**
 * Voice Control Test Page
 * Test page to verify voice control functionality
 */
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-8 bg-gray-100 dark:bg-gray-800 rounded-lg p-4">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm">
            Check the browser console for detailed logs. Open DevTools (F12) to see voice control activity.
          </p>
        </div>
      </div>
    </div>
